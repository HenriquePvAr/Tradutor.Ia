...
| Qualidade / story-text / resíduo físico | ⚠️ implementado com correções offline/forenses até o TDD #66; #68 detectou runtime antigo em #67 (`pipeline_commit_mismatch`), falta novo E2E real pós-guard |
